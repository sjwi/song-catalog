...
public class CustomLogger {
	...
	public void initialize() {
		System.setProperty(LOG_FILE_PROPERTY_KEY,System.getenv("CATALINA_BASE") + "/logs/cfsongsUserFeed");
		...
		public void run() {
			try {
				mailer.sendMail(new Email()
						...
						.setSubject("CF Worship Songs Log Notification"));
