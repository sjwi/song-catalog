...
public class MailConstants {
  ...
  public static void initializeMailConstants(
      String defaultFromAddress, String adminDistributionList, String properName) {
    DEFAULT_FROM_ADDRESS = defaultFromAddress;
    ADMIN_DISTRIBUTION_LIST = adminDistributionList;
    INVITATION_SUBJECT = "{{USERNAME}} has invited you to join the " + properName + ".";
